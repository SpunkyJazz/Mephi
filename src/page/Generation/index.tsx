...
export const GenerationPage = (): JSX.Element => {
  ...
  // options.push(
  //       {
  //         value: 'Интеллектуальные системы и технологии',
  //         label: 'Интеллектуальные системы и технологии'
  //       },
  //       {
  //         value: 'Введение в интеллектуальные системы',
  //         label: 'Введение в интеллектуальные системы'
  //       },
  //       {
  //         value: 'Интеллектуальные диалоговые системы',
  //         label: 'Интеллектуальные диалоговые системы'
  //       },
  //       {
  ...
  //       },
  //       {
  //         value: 'Технология построения динамических интеллектуальных систем',
  //         label: 'Технология построения динамических интеллектуальных систем'
  //       },
  //       {
  //         value: 'Классификации онтологий',
  //         label: 'Классификации онтологий'
  //       },
  //       {
  //         value: 'Методы разработки онтологий',
  //         label: 'Методы разработки онтологий'
  //       },
  //       {
  //         value: 'Языки описания онтологий',
  //         label: 'Языки описания онтологий'
  //       },
  //       {
  //         value: 'Применение онтологий',
  //         label: 'Применение онтологий'
  //       },
  // );
